...
//la classe genera la casella a livello visivo. La casella è composta da due panel:
// quello superiore diviso in quattro parti colora la colonna se la pedina è in quella posizione;
// quella inferiore indica il numero della casella e la tipologia della casella
public class CasellaGUI {
    private JPanel panel, panelSup, pa, pb, pc, pd;
    private int num;
    ...
    //colora la casella in base al giocatore
    ...
    //colora la sella di bianco in case al giocatore che non è più in quella casella
